...
<div class='update-item'>
    ...
    <div>
        <div class="list-item">
            ...
            <form class="items" method="post" action="<?php echo _WEB_ROOT ?>/GroupController/update_group/<?php echo $group['id'] ?>">
                <div>
                    <span>
                ...
                <div class="setting">
                    <input type="submit" name="update-group-btn" value="Cập nhật">
                </div>
            </form>
        </div>
    </div>
